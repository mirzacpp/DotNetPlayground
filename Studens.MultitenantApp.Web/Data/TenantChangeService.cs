namespace Studens.MultitenantApp.Web.Data
{
	...
	///// see <see cref="GetApplicationDbContext"/> at the end of this class. This also allows the DataKey to be added
	...
	//	public TenantChangeService(DbContextOptions<ApplicationDbContext> options,
	//		IShardingConnections connections,
	//		ILogger<TenantChangeService> logger)
	//	{
	//		_options = options;
	...
	//	{
	//		using var context = GetApplicationDbContext(tenant.DatabaseInfoName, tenant.GetTenantDataKey());
	//		if (context == null)
	...
	//		var oldContext = GetApplicationDbContext(oldDatabaseInfoName, oldDataKey);
	//		if (oldContext == null)
	//			return $"There is no connection string with the name {oldDatabaseInfoName}.";

	//		var newContext = GetApplicationDbContext(updatedTenant.DatabaseInfoName, updatedTenant.GetTenantDataKey());
	//		if (newContext == null)
	...
	//	/// <summary>
	//	/// This create a <see cref="ApplicationDbContext"/> with the correct connection string and DataKey
	//	/// </summary>
	//	/// <param name="databaseDataName"></param>
	//	/// <param name="dataKey"></param>
	//	/// <returns><see cref="ApplicationDbContext"/> or null if connectionName wasn't found in the appsetting file</returns>
	//	private ApplicationDbContext? GetApplicationDbContext(string databaseDataName, string dataKey)
	//	{
	//		var connectionString = _connections.FormConnectionString(databaseDataName);
	//		if (connectionString == null)
	//			return null;

	//		return new ApplicationDbContext(_options, new StubGetShardingDataFromUser(connectionString, dataKey));
	//	}
