...
using Rev.AuthPermissions.AdminCode.Services;
using Rev.AuthPermissions.AspNetCore.AccessTenantData;
using Rev.AuthPermissions.AspNetCore.AccessTenantData.Services;
...
using Rev.AuthPermissions.BaseCode.PermissionsCode.Services;
using Rev.AuthPermissions.BaseCode.SetupCode;
using Rev.AuthPermissions.BulkLoadServices;
...
namespace AuthPermissions.AspNetCore
{
	...
	public static class SetupExtensions
	{
		...
		private static void RegisterCommonServices(this AuthSetupData setupData)
		{
			...
			setupData.Services.AddTransient<IUsersAdminService, UsersAdminService>();
