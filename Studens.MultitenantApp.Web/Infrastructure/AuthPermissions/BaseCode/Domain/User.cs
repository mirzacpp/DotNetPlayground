...
namespace Rev.AuthPermissions.BaseCode.DataLayer.Classes
{
	public class User : IdentityUser
	{
		...
		private User(string id, string email, string userName, List<RoleToPermissions> roles, Tenant userTenant)
		{
			...
			_userRoles = new HashSet<UserToRole>(roles.Select(x => new UserToRole(id, x)));
		...
		public static IStatusGeneric<User> CreateUser(string userId, string email, string userName, List<RoleToPermissions> roles, Tenant userTenant = null)
		{
			...
			return status.SetResult(new User(userId, email, userName, roles, userTenant));
		}
		...
		public override string ToString()
		{
			...
			return $"UserName = {UserName}, Email = {Email}, UserId = {Id}{rolesString}{tenantString}.";
		}
		...
		public IStatusGeneric<bool> AddRoleToUser(RoleToPermissions role)
		{
			...
			_userRoles.Add(new UserToRole(Id, role));
