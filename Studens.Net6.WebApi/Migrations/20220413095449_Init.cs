    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserAccessTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUserAccessTokens_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserAccessTokens_UserId",
                table: "AspNetUserAccessTokens",
                column: "UserId");
